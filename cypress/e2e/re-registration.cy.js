describe("Parabank Registration Tests", () => {
  ...
  it("Should show validation errors when submitting empty form", () => {
    ...
    cy.get("#customer\\.firstName\\.errors").should(
      "contain",
      "First name is required."
    );
    cy.get("#customer\\.lastName\\.errors").should(
      "contain",
      "Last name is required."
    );
    cy.get("#customer\\.address\\.street\\.errors").should(
      "contain",
      "Address is required."
    );
    cy.get("#customer\\.address\\.city\\.errors").should(
      "contain",
      "City is required."
    );
    cy.get("#customer\\.address\\.state\\.errors").should(
      "contain",
      "State is required."
    );
    cy.get("#customer\\.address\\.zipCode\\.errors").should(
      "contain",
      "Zip Code is required."
    );
    cy.get("#customer\\.ssn\\.errors").should(
      "contain",
      "Social Security Number is required."
    );
    cy.get("#customer\\.username\\.errors").should(
      "contain",
      "Username is required."
    );
    cy.get("#customer\\.password\\.errors").should(
      "contain",
      "Password is required."
    );
    cy.get("#repeatedPassword\\.errors").should(
      "contain",
